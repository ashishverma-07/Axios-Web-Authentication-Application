...
// Written in VScode by Ashish Verma
// Project 4
...
// const mustache = require('nodemon');
...
// toCheck: [
//   {
//     names: [ 'confirm', 'pwd' ], //maintaining checks
//     multiCheckFn: (values, infos)  {
// values.password === values.confirmPassword, }
//     multiErrorFn: (values, infos) =>
//      `The ${infos.confirmPassword.fN} and ` +
//    `${infos.password.fN} fields do not match`
//   }  //invalid
// ]
// };
...
function setupRoutes(app) {
  ...
  // app.post(LOGIN_URL, checkFn(app));
...
AuthInfo.prototype.cookie = function() {
  ...
  // return `${this.authToken}${cookie}${this.id}`;
